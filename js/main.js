...
loadQuizzBouton.addEventListener('click', async  () => { //Ajout d'un evenment click, quand on click sa affiche les questions
    ...
    fetch('https://opentdb.com/api.php?amount=10&difficulty=easy&type=multiple')// récupération de l'api, on récupere une question
        ...
        .catch(error => { // catch permet de gérer une erreur avec une api, si il y a une erreur sa affiche ce message
           ...
           // reponseC.innerHTML = " Erreur lors du chargement de la question";
           // reponseD.innerHTML = " Erreur lors du chargement de la question";
